...
public class Game {
    ...
    private void oponenteAtaca(Personagem personagem, Personagem oponente){
       int randomNum = (int) (Math.random() * this.dificuldade);
            ...
            switch(opcao){
                ...
                case 2:
                    ...
                    if(personagem.turno != 0){
                        System.out.println("Ataque não carregado, voce precisa esperar " + personagem.turno + "turnos.");
                    } else {
                        System.out.println("Seu turno:");
    ...
    public void start(){
        ...
        switch(opcaoUm){
            case 1 -> this.dificuldade = 4;
            case 2 -> this.dificuldade = 3;
            case 3 -> this.dificuldade = 2;
            case 4 -> this.dificuldade = 1;
        }
            ...
            switch(opcao){
                ...
                case 1:
                    if(fase == 1){
                        ...
                        System.out.println("- Cleber: Esta falando desta chave elegante explorador(a)?");
                        System.out.println("- Cleber: venha pegar se conseguir...");
